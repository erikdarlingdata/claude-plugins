...
- The watchdog aborts any agent at its hard limit (300k tokens or 30 minutes by default), whatever it is doing. The real fix is upstream: land the brief and stop well before 150k.
